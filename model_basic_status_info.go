...
// SetCnt gets a reference to the given float32 and assigns it to the Cnt field.
...
// SetPwr gets a reference to the given string and assigns it to the Pwr field.
...
// SetLvl gets a reference to the given string and assigns it to the Lvl field.
