...
func (r ApiGetDeviceInfoRequest) Execute() (*DeviceSchema, *http.Response, error) {
	return r.ApiService.GetDeviceInfoExecute(r)
}

/*
GetDeviceInfo Method for GetDeviceInfo
...
*/
func (a *DefaultApiService) GetDeviceInfo(ctx context.Context) ApiGetDeviceInfoRequest {
	return ApiGetDeviceInfoRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return DeviceSchema
func (a *DefaultApiService) GetDeviceInfoExecute(r ApiGetDeviceInfoRequest) (*DeviceSchema, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetDeviceInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
